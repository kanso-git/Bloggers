    ...
    test('can see blog create form', async () =>{
     ...
     describe('And using invalid inputs', async()=>{
        ...
        test('the form shows an error message', async ()=>{
            ...
            const expectedText ='You must provide a value';

            expect(titleErr).toEqual(expectedText);
            expect(contentErr).toEqual(expectedText)
        })
     })
     ...
     describe('And using valid inputs', async () => {
        ...
        test('Submitting takes user to review screen', async () => {
            ...
            const confirmText ='Please confirm your entries';
            expect(text).toEqual(confirmText)
        })
        test('Submitting then saving adds blog to index page', async () => {
            await page.click('button.green'); // confrim creation 
